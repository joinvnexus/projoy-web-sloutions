...
export const contactSchema = z.object({
  ...
  subject: z.enum(["", "web-development", "local-seo", "ai-solutions", "white-label", "general"]),
...
export const auditSchema = z.object({
  ...
  service: z.enum(["", "local-seo", "web-development", "saas-development", "ai-integration", "both", "not-sure"]),
  honeypot: z.string().max(0).optional(),
});
