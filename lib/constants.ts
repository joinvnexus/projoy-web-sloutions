...
export const FOOTER_LINKS = {
  services: [
    ...
    { label: "View all →", href: "/services/local-seo" },

    { label: "Technical SEO", href: "/services/technical-seo" },
    { label: "Technical SEO Audit", href: "/services/technical-seo/technical-seo-audit" },
    { label: "Core Web Vitals", href: "/services/technical-seo/core-web-vitals" },
    { label: "Schema Markup", href: "/services/technical-seo/schema-markup" },
    { label: "Technical SEO Fixes", href: "/services/technical-seo/technical-seo-fixes" },
    { label: "View all →", href: "/services/technical-seo" },
    ...
    { label: "View all →", href: "/services/web-development" },
  ],
  company: [
