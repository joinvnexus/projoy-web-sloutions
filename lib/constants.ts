...
export const FOOTER_LINKS = {
  services: [
    ...
    { label: "Business Websites", href: "/services/web-development/business-websites" },
    { label: "Custom Websites", href: "/services/web-development/custom-websites" },
    ...
    { label: "Performance Optimization", href: "/services/web-development/performance-optimization" },
    { label: "SEO-Friendly Development", href: "/services/web-development/seo-friendly-development" },
    { label: "Local SEO", href: "/services/local-seo" },
    { label: "Google Business Profile Optimization", href: "/services/local-seo/google-business-profile" },
    { label: "Google Maps SEO", href: "/services/local-seo/google-maps-ranking" },
    { label: "Local Keyword Research", href: "/services/local-seo/local-keyword-research" },
    { label: "Local Competitor Analysis", href: "/services/local-seo/local-competitor-analysis" },
    { label: "Citation & NAP Optimization", href: "/services/local-seo/citation-building" },
    { label: "Local Landing Pages", href: "/services/local-seo/local-landing-pages" },
    { label: "Review & Reputation Strategy", href: "/services/local-seo/reputation-management" },
    { label: "Local SEO Audit", href: "/services/local-seo/local-seo-audit" },
