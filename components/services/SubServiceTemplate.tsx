...
import { createBreadcrumbSchema, createFaqSchema, ORGANIZATION_ID } from "@/lib/schemas";
...
export function SubServiceTemplate({ data }: { data: SubServiceData }) {
  ...
  const parentHeroMap: Record<SubServiceData['parentSlug'], string> = {
    ...
    "technical-seo": IMAGE_ASSETS.services.technicalSeo,
  };
  ...
  return (
    <>
      ...
      {/* ── Hero ── */}
      <section className="relative bg-white px-8 pt-10 pb-16 overflow-hidden">
        <div
