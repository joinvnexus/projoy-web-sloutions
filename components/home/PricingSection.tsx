...
const categories = [
  { label: "Local SEO", tiers: localSeoPricing },
  { label: "Technical SEO", tiers: technicalSeoPricing },
  { label: "Web Development", tiers: webDevelopmentPricing },
];
    ...
    <section className="section-padding bg-white" aria-labelledby="pricing-heading" id="pricing">
      <div className="container mx-auto max-w-[1200px]">
        <SectionHeader
          ...
          subheading="Starting-from prices for every service. Final pricing depends on project scope, website size, technical requirements, and business goals."
          id="pricing-heading"
        />

        {categories.map((category) => (
          <div key={category.label} className="mb-16 last:mb-0">
            <h3 className="font-display font-bold text-slate-900 text-2xl mb-6 text-center">
              {category.label}
            </h3>
