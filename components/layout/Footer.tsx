...
/* ─── Social icon map ────────────────────────────────────── */
// Note: LinkedIn/Twitter/Facebook represent the organization; GitHub is the
// founder's personal developer profile (linked from the footer for
// convenience) — kept in FOUNDER_CONFIG so it never gets mixed into
// Organization JSON-LD `sameAs`. See lib/schemas/index.ts.
const socialLinks = [
  {
    label: "LinkedIn",
