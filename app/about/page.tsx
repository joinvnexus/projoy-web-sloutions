...
import { createBreadcrumbSchema, createAboutPageSchema } from "@/lib/schemas";
...
export default function AboutPage() {
  ...
  const aboutPage = createAboutPageSchema("/about");

  return (
    <>
      <SchemaMarkup schema={[breadcrumb, aboutPage]} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            <RevealWrapper>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  {SITE_CONFIG.name} was founded by{" "}
                  <Link
                    href={`/about/${FOUNDER_CONFIG.slug}`}
                    className="text-brand-700 font-semibold hover:underline"
                  >
                    {FOUNDER_CONFIG.name}
                  </Link>
                  , a full-stack developer working across the modern JavaScript ecosystem.{" "}
                  <Link
                    href={`/about/${FOUNDER_CONFIG.slug}`}
                    className="text-brand-700 font-semibold hover:underline"
                  >
