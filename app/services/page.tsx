...
export const metadata: Metadata = {
  title: "Services — Web Development, Local SEO & Technical SEO",
  description:
  ...
  openGraph: {
    ...
    description:
      "Web Development, Local SEO, and Technical SEO — connected services designed to help businesses get found and generate more leads.",
...
const services = [
  {
    ...
    description:
      "Build a modern, fast, conversion-focused website. We design and develop business websites, e-commerce platforms, and custom web applications engineered for growth.",
    ...
    stats: [{ value: "Fast", label: "Performance" }, { value: "Custom", label: "Build Approach" }],
  ...
  },
  {
    ...
    title: "Local SEO",
    description:
      "Improve local visibility and Google Maps presence. We help businesses rank in local search and turn visibility into qualified leads.",
  ...
  },
  {
    ...
    title: "Technical SEO",
    description:
      "Identify and fix technical barriers affecting crawling, indexing, and search visibility. We audit, report, and implement approved improvements.",
    ...
    stats: [{ value: "Code", label: "Implementation" }, { value: "5-Step", label: "Process" }],
    gradient: "from-brand-600 to-accent-500",
  },
] as const;
      ...
      <section className="relative bg-white pt-8 pb-16 lg:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto max-w-[1200px] relative z-10 text-center">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-brand-600 to-accent-500 bg-clip-text text-transparent">Visibility &amp; Growth</span>
          </h1>
          <p className="text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto mb-8">
            Website. Technical Foundation. Search Visibility. More Leads.
            <br />
            LocalLeads connects all three so your online presence actually works for your business.
          </p>
          <Link
            href="/contact#audit"
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="text-xs font-bold uppercase tracking-widest text-slate-400">{service.tag}</span>
                        </div>
